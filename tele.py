'''
许大师
Done! Congratulations on your new bot. You will find it at t.me/MasterXu2004_bot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

Use this token to access the HTTP API:
7328937446:AAEphMen-zyNOnAGb_wBmcJVoSAenxGt1ig
...
===xu da shi
Done! Congratulations on your new bot. You will find it at t.me/master_xu_2024_bot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

Use this token to access the HTTP API:
7922198547:AAE_9oojZhm9lh1gt1wJaZtWRVYFFPCAx0g
Keep your token secure and store it safely, it can be used by anyone to control your bot.
